                    ...
                    <div class="col-md-9" data-aos="fade-up">
                        ...
                        <div class="d-md-flex post-entry-2 half">
                            <a href="single-post.html" class="me-4 thumbnail">
                                <img src="{{asset($categoryWiseBlog->image)}}" alt=""  height="263px" width="415px">
                            </a>
                            <div>
                                ...
                                <h3><a href="single-post.html">{{$categoryWiseBlog->title}}</a></h3>
                                <p>{{substr($categoryWiseBlog->description,0,300)}}</p>
