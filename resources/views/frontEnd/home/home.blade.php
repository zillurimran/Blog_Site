                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        ...
                        <div class="post-entry-1 lg">
                            <a href=""><img src="{{asset($sideBlog->image)}}" alt="" height="213px" width="357px"></a>
                            <div class="post-meta"><span class="date">{{ $sideBlog->category_name }}</span> <span class="mx-1">&bullet;</span> <span>{{ $sideBlog->date }}</span></div>
                            <h2><a href="single-post.html">{{ $sideBlog->title }}</a></h2>
                            <p class="mb-4 d-block">{{ $sideBlog->description }}</p>

                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-1.jpg" alt="" class="img-fluid"></div>
                                <div class="name">
                                    <h3 class="m-0 p-0">{{ $sideBlog->author_name }}</h3>
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                @foreach($blog_left as $blog)
                                <div class="post-entry-1">
                                    <a  class="details" id="{{ $blog->id }}">
                                        {{--  {{ route('blog.details',['slug'=> $blog->slug]) }}  --}}
                                        <img src="{{asset($blog->image)}}" alt="" height="133px" width="220px">
                                    </a>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="trending">
                                    ...
                                    <ul class="trending-post">
                                        ...
                                        <li>
                                            <a href="{{ route('blog.details',['slug'=> $trending->slug]) }}">
                                                <span class="number">{{ $i++ }}</span>
                                                <h3>{{ $trending->title }}</h3>
                                                <span class="author">{{ $trending->author_name }}</span>
                                            </a>
                                        </li>
                                        @endforeach
                                    </ul>
